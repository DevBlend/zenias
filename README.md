...
- If you are looking for something to work on, please check our [issues](https://github.com/alayek/zenias/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22).
...
1. `git clone --recursive https://github.com/alayek/zenias.git`
